...
object ReferenceDataSeeder:
  def seedIfNeeded(transactor: Transactor[IO]): IO[Unit] =
    for
      ...
      _ <- seedAirlineManagers(transactor)
    yield ()
  ...
  private val airlineManagerDemoPassword = "Airline2026!"
  private val airlineManagerDemoCreatedAt = Instant.parse("2026-05-18T00:00:00Z")
  private val airlineManagerSeeds = List(
  ...
  private final case class AirlineManagerSeed(
      airlineId: String,
      airlineCode: String,
      airlineName: String,
      managerId: String,
  ...
  private def insertOrUpdateAirline(
      airlineId: String,
      name: String,
      code: String,
      logoAssetPath: String,
  ...
  private def insertOrUpdateAirlineManager(
      managerId: String,
      airlineId: String,
      email: String,
      displayName: String,

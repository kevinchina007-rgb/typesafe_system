...
object DeleteTourGroupMessagePlanner extends ConnectionApiPlan[DeleteTourGroupMessagePlannerRequest, TourGroupMessageListPlannerResponse]:

  override val name: String = "DeleteTourGroupMessagePlanner"

  override def plan(input: DeleteTourGroupMessagePlannerRequest, connection: Connection): IO[TourGroupMessageListPlannerResponse] =
    for

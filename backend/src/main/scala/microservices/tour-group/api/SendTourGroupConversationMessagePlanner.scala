...
object SendTourGroupConversationMessagePlanner extends ConnectionApiPlan[SendTourGroupConversationMessagePlannerInput, TourGroupMessageListPlannerResponse]:

  override val name: String = "SendTourGroupConversationMessagePlanner"

  override def plan(input: SendTourGroupConversationMessagePlannerInput, connection: Connection): IO[TourGroupMessageListPlannerResponse] =
    for

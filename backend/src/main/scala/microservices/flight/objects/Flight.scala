...
object FlightStatus:
  ...
  given sourceEncoder: Encoder[FlightStatus] = Encoder.encodeString.contramap(_.toString)
  given sourceDecoder: Decoder[FlightStatus] = Decoder.decodeString.map(fromText)
...
object InventoryStatus:
  ...
  given sourceEncoder: Encoder[InventoryStatus] = Encoder.encodeString.contramap(_.toString)
  given sourceDecoder: Decoder[InventoryStatus] = Decoder.decodeString.map(fromText)
...
object CabinInventory:
  ...
  given sourceEncoder: Encoder[CabinInventory] = deriveEncoder
  given sourceDecoder: Decoder[CabinInventory] = deriveDecoder
...
object Flight:
  import FlightSourceJsonCodecs.given
  given sourceEncoder: Encoder[Flight] = deriveEncoder
  given sourceDecoder: Decoder[Flight] = deriveDecoder

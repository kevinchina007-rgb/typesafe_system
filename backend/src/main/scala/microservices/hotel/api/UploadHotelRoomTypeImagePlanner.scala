...
object UploadHotelRoomTypeImagePlanner extends ConnectionApiPlan[UploadHotelRoomTypeImagePlannerRequest, HotelRoomTypeImageUploadResponse]:
  override val name: String = "UploadHotelRoomTypeImagePlanner"

  override def plan(input: UploadHotelRoomTypeImagePlannerRequest, connection: Connection): IO[HotelRoomTypeImageUploadResponse] =
    IO.blocking {
      ...
      HotelRoomTypeImageUploadResponse(
        assetId = assetId,

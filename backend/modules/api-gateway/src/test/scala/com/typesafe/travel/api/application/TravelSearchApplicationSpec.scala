...
import com.typesafe.travel.api.memory.{InMemoryFlightRepository, InMemoryHotelRepository, InMemoryOrderRepository, InMemoryTravelerProfileRepository}
...
final class TravelSearchApplicationSpec extends FunSuite:
  ...
  private val flightBookingApplicationService =
    LiveFlightBookingApplicationService[IO](
      ...
      orderService = LiveOrderService[IO](inMemoryOrderRepository),

    ...
    ensureManagerEmailAvailable(primaryEmailAddress) *>
      managerRepository.nextManagerId.flatMap { managerId =>
        managerRepository.saveAirlineManager(
          registerNewAirlineManager(managerId, airlineId, primaryEmailAddress, displayName, createdAt)
        )
      }
    ...
    ensureManagerEmailAvailable(primaryEmailAddress) *>
      managerRepository.nextManagerId.flatMap { managerId =>
        managerRepository.saveHotelManager(
          registerNewHotelManager(managerId, hotelId, primaryEmailAddress, displayName, createdAt)
        )
      }
    ...
    ensureManagerEmailAvailable(primaryEmailAddress) *>
      managerRepository.nextManagerId.flatMap { managerId =>
        managerRepository.saveAttractionManager(
          registerNewAttractionManager(managerId, primaryEmailAddress, displayName, createdAt)
        )
      }

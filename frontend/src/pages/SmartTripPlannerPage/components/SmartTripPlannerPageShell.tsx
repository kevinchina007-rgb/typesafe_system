...
type SmartTripPlannerPageShellProps = SmartTripPlannerPageProps

export function SmartTripPlannerPageShell({ translate, onSelectView }: SmartTripPlannerPageShellProps) {
  return (

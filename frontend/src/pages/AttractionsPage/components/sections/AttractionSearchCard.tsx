...
export function AttractionSearchCard({
  ...
  return (
    <section className="grid gap-5 border border-slate-200 bg-white p-6 text-slate-950 shadow-sm shadow-slate-200/50">
      ...
      <div className="grid items-end gap-4 md:grid-cols-[1fr_1fr_auto]">
        ...
        <label className="grid gap-2 text-sm font-medium text-slate-600">
          ...
          <select value={sortPreference} onChange={event => onSortPreferenceChange(event.target.value as AttractionSearchCardProps['sortPreference'])}>

// 本文件定义 AttractionsPage 页面的状态控制逻辑，负责条件维护、请求触发和动作调度。

import { useAttractionSearchStore } from '@/app/stores/attraction-search-store'

export function useAttractionsSearchState() {

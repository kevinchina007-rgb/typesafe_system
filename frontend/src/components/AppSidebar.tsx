...
const guestSidebarViews: AppViewKey[] = ['explore', 'trains', 'manager', 'trainAdmin']
const signedInSidebarViews: AppViewKey[] = ['explore', 'account', 'travelers', 'flights', 'hotels', 'trains', 'bookings', 'manager', 'trainAdmin']

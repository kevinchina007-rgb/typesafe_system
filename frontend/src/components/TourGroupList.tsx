import type { AppLanguage, TourGroupSummaryResponse, UserResponse } from '../lib/mvp-types'
import { formatGroupCardSubtitle, getTourGroupConceptLabel } from '../lib/tour-group-presenter'
